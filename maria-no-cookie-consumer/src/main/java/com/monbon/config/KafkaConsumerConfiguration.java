...
public class KafkaConsumerConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, CookieVo> cookieVoConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, groupId);
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class.getName());
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, CookieVo> cookieVoKafkaListenerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, CookieVo> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(cookieVoConsumerFactory());
        return factory;
    }
